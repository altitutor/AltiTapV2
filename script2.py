...
def load_students_by_day(selected_day):
    ...
    with open('names.json', 'w', encoding='utf-8') as json_file:
        json.dump({'names': students_by_day}, json_file, indent=4)
...
# Map from Python's weekday to the dropdown format
weekday_to_dropdown = {
    0: "1.Monday",
    2: "2.Tuesday",
    1: "3.Wednesday",
    3: "4.Thursday",
    4: "5.Friday",  # Assuming you want to add Friday
    5: "6.Saturday AM",  # Adjust based on your AM/PM logic
    6: "7.Sunday AM",  # Adjust for Sunday
}

# Get current weekday and map it to dropdown option
current_weekday = datetime.now().weekday()
selected_day_str = weekday_to_dropdown.get(current_weekday, "Select a day")

# Dropdown for selecting a day
day_var = StringVar(root)
day_var.set(selected_day_str)  # Automatically set to current day
